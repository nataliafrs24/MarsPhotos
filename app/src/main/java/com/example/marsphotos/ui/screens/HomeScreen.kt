...
// Menampilkan komponen berdasarkan status UI Mars
@Composable
...
/**
 * Layar utama yang menampilkan pesan error beserta tombol untuk mencoba lagi.
 */
@Composable
fun ErrorScreen(retryAction: () -> Unit, modifier: Modifier = Modifier) {
    // Menampilkan komponen error dengan gambar dan tombol retry
    Column(
        modifier = modifier,
